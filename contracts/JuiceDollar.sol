...
/**
 * @title JuiceDollar
 * @notice The JuiceDollar (JUSD) is an ERC-20 token that is designed to track the value of the Euro.
...
contract JuiceDollar is ERC20Permit, ERC3009, IJuiceDollar, ERC165 {
    ...
    /**
     * @notice The amount of equity of the JuiceDollar system in JUSD, owned by the holders of Native Decentralized Euro Protocol Shares.
