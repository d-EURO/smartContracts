...
import {IOptimismMintableERC20, ILegacyMintableERC20} from "./interface/IOptimismMintableERC20.sol";
import {ERC20} from "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import {ERC20Permit} from "@openzeppelin/contracts/token/ERC20/extensions/ERC20Permit.sol";
import {IERC165} from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

contract BridgedDEPS is ERC20Permit, ERC3009, IOptimismMintableERC20, ILegacyMintableERC20 {
    ...
    modifier onlyBridge() {
        require(msg.sender == BRIDGE, "DEPS: only bridge can mint and burn");
        _;
    }
    ...
    ) ERC20Permit("Decentralized Euro Protocol Share") ERC20(_name, _symbol) {
