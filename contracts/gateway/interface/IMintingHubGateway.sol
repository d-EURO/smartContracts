...
interface IMintingHubGateway {
    ...
    function clone(address owner, address parent, uint256 _initialCollateral, uint256 _initialMint, uint40 expiration, bytes32 frontendCode) external payable returns (address);
