...
contract CoinLendingGateway is ICoinLendingGateway, Ownable, ReentrancyGuard, Pausable {
     ...
     * @param _deuro The address of the JuiceDollar contract
     */
    ...
    function _lendWithCoin(
        ...
        uint256 deuroBalance = JUSD.balanceOf(address(this));
        if (deuroBalance > 0) {
            JUSD.transfer(owner, deuroBalance);
        }
